...
const typeStyles = {
  success: {
    container: 'bg-gradient-to-r from-emerald-500 to-green-600 border-emerald-400/20',
  ...
  warning: {
    container: 'bg-gradient-to-r from-amber-500 to-orange-600 border-amber-400/20',
    icon: 'text-amber-100',
    title: 'text-white',
  ...
  info: {
    container: 'bg-gradient-to-r from-blue-500 to-indigo-600 border-blue-400/20',
    icon: 'text-blue-100',
    title: 'text-white',
...
export const ToastContainer: React.FC<ToastContainerProps> = ({
  ...
  return (
    <div className={cn('fixed z-50 space-y-2 w-80 md:w-80 sm:w-full', getPositionClasses())}>
