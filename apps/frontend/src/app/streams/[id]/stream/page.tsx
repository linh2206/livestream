            ...
            <div className='mb-6'>
              <div className='flex items-center justify-between mb-4'>
                ...
                <div className='flex items-center space-x-3'>
                  ...
                  <div className='flex items-center space-x-2 bg-black/60 backdrop-blur-sm text-white px-3 py-2 rounded-full text-sm font-medium'>
                    <svg
                      className='w-4 h-4'
                      fill='currentColor'
                      viewBox='0 0 20 20'
                  ...
                  >
                    <div
                      className={`w-2 h-2 rounded-full ${isStreaming ? 'bg-white animate-pulse' : 'bg-gray-400'}`}
                    ></div>
