...
export default function AdminAnalyticsPage() {
      ...
      const fetchAnalytics = async () => {
        try {
          ...
          const analyticsData: AnalyticsData = {
            ...
            activeUsers: (usersData as any).data?.filter((u: any) => u.isActive).length || 0,
            totalStreams: (streamsData as any).data?.length || 0,
            activeStreams: (streamsData as any).data?.filter((s: any) => s.isLive).length || 0,
            totalViews: (streamsData as any).data?.reduce((sum: number, s: any) => sum + (s.viewerCount || 0), 0) || 0,
  ...
  const memoizedStats = useMemo(() => {
    ...
    return {
      avgViewsPerStream: analytics.totalStreams > 0 
        ? Math.round(analytics.totalViews / analytics.totalStreams) 
        : 0,
      avgMessagesPerStream: analytics.totalStreams > 0 
        ? Math.round(analytics.totalMessages / analytics.totalStreams) 
        : 0,
      userEngagement: analytics.totalUsers > 0 
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-lg p-6">
                ...
                <div className="text-3xl font-bold">{analytics.totalStreams.toLocaleString()}</div>
                <div className="text-sm opacity-80">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="bg-gray-800 rounded-lg p-6">
                <h3 className="text-lg font-semibold mb-2">Stream Success Rate</h3>
                <div className="text-2xl font-bold text-green-400">
                  {analytics.totalStreams > 0 
                    ? Math.round((analytics.activeStreams / analytics.totalStreams) * 100) 
                    : 0}%
                </div>
                <div className="text-sm text-gray-400">
              ...
              <div className="bg-gray-800 rounded-lg p-6">
                <h3 className="text-lg font-semibold mb-2">Avg Views/Stream</h3>
            ...
            <div className="bg-gray-800 rounded-lg p-6 mb-8">
              ...
              <div className="space-y-4">
                {analytics.topStreamers.slice(0, 5).map((streamer, index) => (
                  <div key={streamer.username} className="flex items-center justify-between p-4 bg-gray-700 rounded-lg">
