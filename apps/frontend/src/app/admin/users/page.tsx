...
export default function AdminUsersPage() {
  ...
  const { users, isLoading: usersLoading, error: usersError, mutate } = useUsersList();
  ...
  // Show loading state before filtering
  if (usersLoading) {
    return (
      <div className="flex items-center justify-center p-6">
        <div className="text-center">
    ...
    return (
      <div className="flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <p className="text-gray-300">{usersError.message}</p>
        </div>
      </div>
    );
  }
