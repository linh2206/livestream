      ...
      <div className="bg-glass-white backdrop-blur-md rounded-2xl p-8 w-full max-w-md mx-4">
        ...
        <div className="mt-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full mt-4 bg-white hover:bg-gray-100 disabled:bg-gray-300 text-gray-900 py-3 rounded-lg font-semibold transition-colors flex items-center justify-center space-x-2"
          >
